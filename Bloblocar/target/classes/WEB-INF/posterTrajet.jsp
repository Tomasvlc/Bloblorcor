            ...
            <form method="post" action="./NewTrajetServlet">
			  <div class="form-row">
				<div class="form-group col-md-6">
				  <label for="inputEmail4">Point de départ</label>
				  <input name="depart" type="text" id="inputPointDeDépart" class="form-control"  placeholder="Point de départ" autocomplete="off">
				</div>
				<div class="form-group col-md-6">
				...
				<div class="form-row">
					<div class="form-group col-md-4">
						<label for="inputState">Heure d'arrivé</label>
